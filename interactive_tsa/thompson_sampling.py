...
def plot_machine_selection_and_distributions(machine_selection_counts, trial, n_machines, alpha, beta_params):
    ...
    axs[1].set_title("Beta Distributions")
...
def interactive_three_machines_with_visualization():
    ...
    while True:
        print(f"\n--- Trial {trial} ---")
        suggested_machine = ts.select_machine()
        ...
        plot_machine_selection_and_distributions(machine_selection_counts, trial - 1, n_machines, ts.alpha, ts.beta)
